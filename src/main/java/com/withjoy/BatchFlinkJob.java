...
public class BatchFlinkJob {
    ...
    private static HashMap<String, Integer> activity_string_int = new HashMap<String, Integer>();
    private static HashMap<String, Integer> tracks_string_int = new HashMap<String, Integer>();
    ...
    public BatchFlinkJob(ParameterTool params){
       ...
       // set up the batch execution environment        
        ...
        String aws_bucket_in = properties.getProperty("aws_bucket_in");
        String aws_bucket_out = properties.getProperty("aws_bucket_out");
        
        final HashMap<String, Integer> activity_string_int = ReadPostgreSQL.getSQLHash("SELECT * FROM "+schema+"."+params.get("input")+" LIMIT 1");
        final HashMap<String, Integer> tracks_string_int = ReadPostgreSQL.getSQLHash("SELECT * FROM "+schema+"."+"tracks"+" LIMIT 1");
        final HashMap<Integer, String> activity_int_string = new HashMap<Integer, String>();
        final HashMap<Integer, String> tracks_int_string = new HashMap<Integer, String>();
        ...
        DataSet<String> text = env.readTextFile("s3a://"+aws_bucket_in+"/"+params.get("input"));

        DataSet<String> text_with_json = text.map(new MapFunction<String, String>(){
        ...
        try{
            if (params.has("output")) {
                text_with_json.writeAsText("s3a://"+aws_bucket_out+"/"+params.get("output"),WriteMode.OVERWRITE);
